...
class Layout extends \Shopware\Models\Shop\TemplateConfig\Layout implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'name', 'type', 'templateId', 'template', 'parentId', 'parent', 'title', 'attributes', 'children', 'elements', '' . "\0" . 'Shopware\\Models\\Shop\\TemplateConfig\\Layout' . "\0" . 'id'];
        }
