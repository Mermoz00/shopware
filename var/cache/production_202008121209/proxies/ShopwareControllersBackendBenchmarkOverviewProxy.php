<?php
class Shopware_Proxies_ShopwareControllersBackendBenchmarkOverviewProxy extends Shopware_Controllers_Backend_BenchmarkOverview implements Enlight_Hook_Proxy
{
