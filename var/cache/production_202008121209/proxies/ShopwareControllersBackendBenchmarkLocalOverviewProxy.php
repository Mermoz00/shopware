<?php
class Shopware_Proxies_ShopwareControllersBackendBenchmarkLocalOverviewProxy extends Shopware_Controllers_Backend_BenchmarkLocalOverview implements Enlight_Hook_Proxy
{
