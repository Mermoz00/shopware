<?php /* Smarty version Smarty-3.1.12, created on 2020-09-09 09:25:12
         compiled from "/var/www/html/shopware_test/themes/Backend/ExtJs/backend/base/component/Shopware.MediaManager.MediaSelection.js" */ ?>
<?php /*%%SmartyHeaderCode:7956198185f5883581ffa25-33164781%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '4d7ac6c4633ecf70bf8102e020d8d1e45929d6b8' => 
    array (
      0 => '/var/www/html/shopware_test/themes/Backend/ExtJs/backend/base/component/Shopware.MediaManager.MediaSelection.js',
      1 => 1598958813,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '7956198185f5883581ffa25-33164781',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_5f588358206c65_31689741',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5f588358206c65_31689741')) {function content_5f588358206c65_31689741($_smarty_tpl) {?>/**
 * Shopware 5
...
/** @lends Ext.form.field.Trigger */
{
     ...
     * @string
     */
    buttonText: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'backend'/'base'/'component'/'media_selection'/'button_text','default'=>'Select own files','namespace'=>'backend/base/component/Shopware.MediaManager.MediaSelection')); $_block_repeat=true; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'backend'/'base'/'component'/'media_selection'/'button_text','default'=>'Select own files','namespace'=>'backend/base/component/Shopware.MediaManager.MediaSelection'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Datei(en) auswählen...<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'backend'/'base'/'component'/'media_selection'/'button_text','default'=>'Select own files','namespace'=>'backend/base/component/Shopware.MediaManager.MediaSelection'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
