<?php /* Smarty version Smarty-3.1.12, created on 2020-09-09 09:25:12
         compiled from "/var/www/html/shopware_test/themes/Backend/ExtJs/backend/base/component/Shopware.Notification.js" */ ?>
<?php /*%%SmartyHeaderCode:9049804125f58835824a980-12303561%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '67e96cdb1beaa155b49ba8448e9beeb7cb43b196' => 
    array (
      0 => '/var/www/html/shopware_test/themes/Backend/ExtJs/backend/base/component/Shopware.Notification.js',
      1 => 1598958813,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '9049804125f58835824a980-12303561',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_5f58835826a415_07416425',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5f58835826a415_07416425')) {function content_5f58835826a415_07416425($_smarty_tpl) {?>/**
 * Shopware 5
...
Ext.define('Shopware.Notification', {
    ...
    */
    ...
    createGrowlMessage: function(title, text, caller, iconCls, log) {
        ...
        if (log != false) {
            Ext.Ajax.request({
                url: '<?php echo '/backend/Logger/createLog';?>',
                params: {
                    type: 'backend',
                    key: caller,
                    text: text,
    ...
    getNotificationOptions: function (text) {
        return {
            icon: 'http://shopware.localhost/themes/Frontend/Responsive/frontend/_public/src/img/favicon.ico',
            body: text
        };
    },
