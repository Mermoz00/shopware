<?php /* Smarty version Smarty-3.1.12, created on 2020-09-09 10:28:54
         compiled from "/var/www/html/shopware_test/engine/Shopware/Plugins/Default/Backend/PluginManager/Views/backend/plugin_manager/view/list/premium_plugins_page.js" */ ?>
<?php /*%%SmartyHeaderCode:9850359725f589246147af2-16709195%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a1aeb33a18f9e715b01c93881e62435d04b6e6ef' => 
    array (
      0 => '/var/www/html/shopware_test/engine/Shopware/Plugins/Default/Backend/PluginManager/Views/backend/plugin_manager/view/list/premium_plugins_page.js',
      1 => 1598958813,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '9850359725f589246147af2-16709195',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_5f589246151112_06094729',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5f589246151112_06094729')) {function content_5f589246151112_06094729($_smarty_tpl) {?>/**
 * Shopware 5
        ...
        return Ext.create('Ext.container.Container', {
            ...
            items: [
                Ext.create('Ext.container.Container', {
                    html: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'premium_plugins/headline','default'=>'Shopware Premium Plugins - Try for free!','namespace'=>'backend/plugin_manager/translation')); $_block_repeat=true; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'premium_plugins/headline','default'=>'Shopware Premium Plugins - Try for free!','namespace'=>'backend/plugin_manager/translation'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Shopware Premium Plugins - 30 Tage kostenlos testen<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'premium_plugins/headline','default'=>'Shopware Premium Plugins - Try for free!','namespace'=>'backend/plugin_manager/translation'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
                    cls: 'headline',
                    padding: '30 30 0 30'
                }),
                Ext.create('Ext.container.Container', {
                    html: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'premium_plugins/description_text','default'=>'Try our premium plugins 30 days free of charge and without obligation.','namespace'=>'backend/plugin_manager/translation')); $_block_repeat=true; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'premium_plugins/description_text','default'=>'Try our premium plugins 30 days free of charge and without obligation.','namespace'=>'backend/plugin_manager/translation'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Erweitere Deinen Store um hochwertige Premium Features und bau den Erfolg Deines Online-Business weiter aus. Nutze die Gelegenheit Dich von der Qualität und dem Nutzen der Shopware Premium Plugins zu überzeugen. Teste jetzt \<b\>völlig unverbindlich\</b\> unsere Premium Plugins für volle \<b\>30 Tage lang kostenlos\</b\>.<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'premium_plugins/description_text','default'=>'Try our premium plugins 30 days free of charge and without obligation.','namespace'=>'backend/plugin_manager/translation'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
                    padding: '10 30 0 30'
                })
            ]
...
',
                ...
                return Ext.create('PluginManager.container.Container', {
                    cls: 'button configure',
                    html: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'premium_plugins/try_button','default'=>'Try now','namespace'=>'backend/plugin_manager/translation')); $_block_repeat=true; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'premium_plugins/try_button','default'=>'Try now','namespace'=>'backend/plugin_manager/translation'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Jetzt testen<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'premium_plugins/try_button','default'=>'Try now','namespace'=>'backend/plugin_manager/translation'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
                    handler: handlerCallback
                });
            }
