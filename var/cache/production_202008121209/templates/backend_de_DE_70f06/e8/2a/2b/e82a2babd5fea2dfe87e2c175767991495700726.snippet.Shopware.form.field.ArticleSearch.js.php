<?php /* Smarty version Smarty-3.1.12, created on 2020-09-09 09:25:12
         compiled from "/var/www/html/shopware_test/themes/Backend/ExtJs/backend/base/component/Shopware.form.field.ArticleSearch.js" */ ?>
<?php /*%%SmartyHeaderCode:19175357065f58835827ec74-94469794%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e82a2babd5fea2dfe87e2c175767991495700726' => 
    array (
      0 => '/var/www/html/shopware_test/themes/Backend/ExtJs/backend/base/component/Shopware.form.field.ArticleSearch.js',
      1 => 1598958813,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '19175357065f58835827ec74-94469794',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_5f588358295406_83735934',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5f588358295406_83735934')) {function content_5f588358295406_83735934($_smarty_tpl) {?>/**
 * Shopware 5
...
/** @lends Ext.container.Container# */
{
     ...
     * @string
     */
    confirmButtonText: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'save_assigned_articles','default'=>'Save assigned articles','namespace'=>'backend/base/article_search')); $_block_repeat=true; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'save_assigned_articles','default'=>'Save assigned articles','namespace'=>'backend/base/article_search'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Zugewiesene Artikel speichern<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'save_assigned_articles','default'=>'Save assigned articles','namespace'=>'backend/base/article_search'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
     ...
     * @string
     */
    cancelButtonText: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'reset_articles','default'=>'Reset articles','namespace'=>'backend/base/article_search')); $_block_repeat=true; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'reset_articles','default'=>'Reset articles','namespace'=>'backend/base/article_search'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Artikel zurücksetzen<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'reset_articles','default'=>'Reset articles','namespace'=>'backend/base/article_search'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
     ...
     */
    emptyText: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'search_default_text','default'=>'Search...','namespace'=>'backend/base/article_search')); $_block_repeat=true; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'search_default_text','default'=>'Search...','namespace'=>'backend/base/article_search'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Suche...<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'search_default_text','default'=>'Search...','namespace'=>'backend/base/article_search'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',

    snippets: {
        assignedArticles: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'assigned_articles','default'=>'Assigned articles','namespace'=>'backend/base/article_search')); $_block_repeat=true; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'assigned_articles','default'=>'Assigned articles','namespace'=>'backend/base/article_search'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Zugewiesene Artikel<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'assigned_articles','default'=>'Assigned articles','namespace'=>'backend/base/article_search'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
        articleName: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'article_name','default'=>'Article name','namespace'=>'backend/base/article_search')); $_block_repeat=true; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'article_name','default'=>'Article name','namespace'=>'backend/base/article_search'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Artikelname<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'article_name','default'=>'Article name','namespace'=>'backend/base/article_search'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
        orderNumber: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'ordernumber','default'=>'Order number','namespace'=>'backend/base/article_search')); $_block_repeat=true; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'ordernumber','default'=>'Order number','namespace'=>'backend/base/article_search'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Bestellnummer<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'ordernumber','default'=>'Order number','namespace'=>'backend/base/article_search'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
        dropDownTitle: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'search_result'/'article','default'=>'Article','namespace'=>'backend/base/article_search')); $_block_repeat=true; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'search_result'/'article','default'=>'Article','namespace'=>'backend/base/article_search'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Artikel<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'search_result'/'article','default'=>'Article','namespace'=>'backend/base/article_search'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
'
    },
