<?php /* Smarty version Smarty-3.1.12, created on 2020-09-09 09:25:14
         compiled from "/var/www/html/shopware_test/themes/Backend/ExtJs/backend/customer/controller/detail.js" */ ?>
<?php /*%%SmartyHeaderCode:19698899735f58835a8ecf95-45802495%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'cf6e71ff07e45581b37306175df3736c09a052f0' => 
    array (
      0 => '/var/www/html/shopware_test/themes/Backend/ExtJs/backend/customer/controller/detail.js',
      1 => 1598958813,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '19698899735f58835a8ecf95-45802495',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_5f58835a92cfa6_64124826',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5f58835a92cfa6_64124826')) {function content_5f58835a92cfa6_64124826($_smarty_tpl) {?>/**
 * Shopware 5
...
Ext.define('Shopware.apps.Customer.controller.Detail', {
    ...
    snippets: {
        form: {
            errorTitle: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'message'/'password'/'form'/'error_title','default'=>'Error saving the form','namespace'=>'backend/customer/view/detail')); $_block_repeat=true; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'message'/'password'/'form'/'error_title','default'=>'Error saving the form','namespace'=>'backend/customer/view/detail'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Fehler beim Speichern des Formulars<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'message'/'password'/'form'/'error_title','default'=>'Error saving the form','namespace'=>'backend/customer/view/detail'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
            errorMessage: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'message'/'password'/'form'/'error_message','default'=>'The field [0] is not valid','namespace'=>'backend/customer/view/detail')); $_block_repeat=true; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'message'/'password'/'form'/'error_message','default'=>'The field [0] is not valid','namespace'=>'backend/customer/view/detail'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Das Feld [0] ist nicht gültig<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'message'/'password'/'form'/'error_message','default'=>'The field [0] is not valid','namespace'=>'backend/customer/view/detail'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
'
        },
        password: {
            support: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'message'/'password'/'generated_password','default'=>'The generated password is:','namespace'=>'backend/customer/view/detail')); $_block_repeat=true; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'message'/'password'/'generated_password','default'=>'The generated password is:','namespace'=>'backend/customer/view/detail'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
...
',
            successTitle: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'message'/'password'/'success_title','default'=>'Successfully','namespace'=>'backend/customer/view/detail')); $_block_repeat=true; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'message'/'password'/'success_title','default'=>'Successfully','namespace'=>'backend/customer/view/detail'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Erfolgreich<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'message'/'password'/'success_title','default'=>'Successfully','namespace'=>'backend/customer/view/detail'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
            successText: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'message'/'password'/'success_text','default'=>'Customer [0] has been saved','namespace'=>'backend/customer/view/detail')); $_block_repeat=true; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'message'/'password'/'success_text','default'=>'Customer [0] has been saved','namespace'=>'backend/customer/view/detail'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Kunde [0] wurde gespeichert<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'message'/'password'/'success_text','default'=>'Customer [0] has been saved','namespace'=>'backend/customer/view/detail'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
            errorTitle: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'message'/'password'/'error_title','default'=>'Failure','namespace'=>'backend/customer/view/detail')); $_block_repeat=true; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'message'/'password'/'error_title','default'=>'Failure','namespace'=>'backend/customer/view/detail'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Fehler<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'message'/'password'/'error_title','default'=>'Failure','namespace'=>'backend/customer/view/detail'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
            errorText: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'message'/'password'/'error_text','default'=>'There is an error occurred while saving.','namespace'=>'backend/customer/view/detail')); $_block_repeat=true; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'message'/'password'/'error_text','default'=>'There is an error occurred while saving.','namespace'=>'backend/customer/view/detail'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
...
'
        ...
        account: {
            successTitle: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'message'/'account'/'success_title','default'=>'Successfully','namespace'=>'backend/customer/view/detail')); $_block_repeat=true; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'message'/'account'/'success_title','default'=>'Successfully','namespace'=>'backend/customer/view/detail'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Erfolgreich<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'message'/'account'/'success_title','default'=>'Successfully','namespace'=>'backend/customer/view/detail'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
            successText: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'message'/'account'/'success_text','default'=>'The account for the customer [0] has been created successfully.','namespace'=>'backend/customer/view/detail')); $_block_repeat=true; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'message'/'account'/'success_text','default'=>'The account for the customer [0] has been created successfully.','namespace'=>'backend/customer/view/detail'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Das Kundenkonto für den Kunden [0] wurde erfolgreich erstellt.<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'message'/'account'/'success_text','default'=>'The account for the customer [0] has been created successfully.','namespace'=>'backend/customer/view/detail'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
            errorTitle: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'message'/'account'/'error_title','default'=>'Failure','namespace'=>'backend/customer/view/detail')); $_block_repeat=true; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'message'/'account'/'error_title','default'=>'Failure','namespace'=>'backend/customer/view/detail'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Fehler<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'message'/'account'/'error_title','default'=>'Failure','namespace'=>'backend/customer/view/detail'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
            errorText: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'message'/'account'/'error_text','default'=>'There is an error occurred while saving.','namespace'=>'backend/customer/view/detail')); $_block_repeat=true; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'message'/'account'/'error_text','default'=>'There is an error occurred while saving.','namespace'=>'backend/customer/view/detail'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Während des Speicherns ist ein Fehler aufgetreten.<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'message'/'account'/'error_text','default'=>'There is an error occurred while saving.','namespace'=>'backend/customer/view/detail'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
'
        },
        overwriteCustomer: {
            title: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'overwriteCustomer'/'title','default'=>'Overwrite most recent changes','namespace'=>'backend/customer/view/detail')); $_block_repeat=true; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'overwriteCustomer'/'title','default'=>'Overwrite most recent changes','namespace'=>'backend/customer/view/detail'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Jüngste Änderungen überschreiben<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'overwriteCustomer'/'title','default'=>'Overwrite most recent changes','namespace'=>'backend/customer/view/detail'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
            message: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'overwriteCustomer'/'message','default'=>'Do you really want to overwrite the latest changes?','namespace'=>'backend/customer/view/detail')); $_block_repeat=true; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'overwriteCustomer'/'message','default'=>'Do you really want to overwrite the latest changes?','namespace'=>'backend/customer/view/detail'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Der Kunde wurde zwischenzeitlich durch einen anderen Benutzer geändert. Um zu verhindern, dass diese Änderungen überschrieben werden, wurde das Speichern des Kunden verhindert. <br /> <br />Um diese Änderungen anzuzeigen, schließen Sie bitte den Kunden und öffnen Sie sie erneut.<br /><br /><b>Wollen Sie die jüngsten Änderungen überschreiben?</b><?php $_block_content = ob_get_clean(); $_block_repeat=false; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'overwriteCustomer'/'message','default'=>'Do you really want to overwrite the latest changes?','namespace'=>'backend/customer/view/detail'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
        },

        unlock: {
            successTitle: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'base'/'unlock_customer'/'success_title','default'=>'Successfully','namespace'=>'backend/customer/view/detail')); $_block_repeat=true; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'base'/'unlock_customer'/'success_title','default'=>'Successfully','namespace'=>'backend/customer/view/detail'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Erfolgreich<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'base'/'unlock_customer'/'success_title','default'=>'Successfully','namespace'=>'backend/customer/view/detail'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
            successText: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'base'/'unlock_customer'/'success_text','default'=>'Successfully unlocked the customer.','namespace'=>'backend/customer/view/detail')); $_block_repeat=true; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'base'/'unlock_customer'/'success_text','default'=>'Successfully unlocked the customer.','namespace'=>'backend/customer/view/detail'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Der Kunde wurde erfolgreich entsperrt.<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'base'/'unlock_customer'/'success_text','default'=>'Successfully unlocked the customer.','namespace'=>'backend/customer/view/detail'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
            errorTitle: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'base'/'unlock_customer'/'error_title','default'=>'Failure','namespace'=>'backend/customer/view/detail')); $_block_repeat=true; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'base'/'unlock_customer'/'error_title','default'=>'Failure','namespace'=>'backend/customer/view/detail'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Fehler<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'base'/'unlock_customer'/'error_title','default'=>'Failure','namespace'=>'backend/customer/view/detail'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
            errorText: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'base'/'unlock_customer'/'error_text','default'=>'An error occurred while unlocking the customer.','namespace'=>'backend/customer/view/detail')); $_block_repeat=true; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'base'/'unlock_customer'/'error_text','default'=>'An error occurred while unlocking the customer.','namespace'=>'backend/customer/view/detail'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Beim Entsperren des Kundens ist ein Fehler aufgetreten.<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'base'/'unlock_customer'/'error_text','default'=>'An error occurred while unlocking the customer.','namespace'=>'backend/customer/view/detail'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
'
        },

        growlMessage: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'message'/'growlMessage','default'=>'Customer','namespace'=>'backend/customer/view/detail')); $_block_repeat=true; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'message'/'growlMessage','default'=>'Customer','namespace'=>'backend/customer/view/detail'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Kunden<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'message'/'growlMessage','default'=>'Customer','namespace'=>'backend/customer/view/detail'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
'
    },
...
<?php $_tmp1=ob_get_clean();?><?php if ($_tmp1){?> */
    ...
    onPerformOrder: function (record) {
        window.open('<?php echo '/backend/customer/performOrder';?>?id=' + record.get('id') + '&__csrf_token=' + Ext.CSRFService.getToken());
    },
...
<?php $_tmp2=ob_get_clean();?><?php if ($_tmp2){?> */
    ...
    onSaveCustomer: function (btn) {
        var me = this, number,
            ...
            missingField = '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'unknown_field','default'=>'Unknown field','namespace'=>'backend/customer/view/detail')); $_block_repeat=true; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'unknown_field','default'=>'Unknown field','namespace'=>'backend/customer/view/detail'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Unknown field<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'unknown_field','default'=>'Unknown field','namespace'=>'backend/customer/view/detail'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
';
    ...
    onUnlockCustomer: function (unlockContainer, record) {
        ...
        Ext.Ajax.request({
            url: '<?php echo '/backend/customer/unlockCustomer';?>',
            params: {
