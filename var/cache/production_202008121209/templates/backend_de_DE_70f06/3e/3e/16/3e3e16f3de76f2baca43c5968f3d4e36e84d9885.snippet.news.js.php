<?php /* Smarty version Smarty-3.1.12, created on 2020-09-08 16:09:21
         compiled from "/var/www/html/shopware_test/themes/Backend/ExtJs/backend/index/view/widgets/news.js" */ ?>
<?php /*%%SmartyHeaderCode:14509854485f579091dfd3e5-60880437%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3e3e16f3de76f2baca43c5968f3d4e36e84d9885' => 
    array (
      0 => '/var/www/html/shopware_test/themes/Backend/ExtJs/backend/index/view/widgets/news.js',
      1 => 1598958813,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '14509854485f579091dfd3e5-60880437',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_5f579091e080c0_09816844',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5f579091e080c0_09816844')) {function content_5f579091e080c0_09816844($_smarty_tpl) {?>/**
 * Shopware 5
...
Ext.define('Shopware.apps.Index.view.widgets.News', {
    ...
    title: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'news'/'title','default'=>'shopware News','namespace'=>'backend/index/view/widgets')); $_block_repeat=true; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'news'/'title','default'=>'shopware News','namespace'=>'backend/index/view/widgets'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Shopware News<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'news'/'title','default'=>'shopware News','namespace'=>'backend/index/view/widgets'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
    layout: 'fit',
    bodyPadding: '8 8',
     ...
     */
    snippets: {
        offlineMsg: "<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'news'/'offline_msg','default'=>'We can\'t establish a connection to the Shopware server. Please check your connection and try again later.','namespace'=>'backend/index/view/widgets')); $_block_repeat=true; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'news'/'offline_msg','default'=>'We can\'t establish a connection to the Shopware server. Please check your connection and try again later.','namespace'=>'backend/index/view/widgets'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Wir können leider keine Verbindung zum Shopware Server aufbauen. Bitte prüfe Deine Internet-Verbindung und probiere es erneut.<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'news'/'offline_msg','default'=>'We can\'t establish a connection to the Shopware server. Please check your connection and try again later.','namespace'=>'backend/index/view/widgets'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
",
        headers: {
            pubDate: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'news'/'headers'/'date','default'=>'Date','namespace'=>'backend/index/view/widgets')); $_block_repeat=true; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'news'/'headers'/'date','default'=>'Date','namespace'=>'backend/index/view/widgets'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Datum<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'news'/'headers'/'date','default'=>'Date','namespace'=>'backend/index/view/widgets'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
            title: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'news'/'headers'/'title','default'=>'Title','namespace'=>'backend/index/view/widgets')); $_block_repeat=true; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'news'/'headers'/'title','default'=>'Title','namespace'=>'backend/index/view/widgets'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Titel<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'news'/'headers'/'title','default'=>'Title','namespace'=>'backend/index/view/widgets'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
'
        }
    },
