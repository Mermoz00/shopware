<?php /* Smarty version Smarty-3.1.12, created on 2020-09-08 16:09:21
         compiled from "/var/www/html/shopware_test/themes/Backend/ExtJs/backend/index/view/widgets/sales.js" */ ?>
<?php /*%%SmartyHeaderCode:21429534085f579091d73cf6-17580670%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '937211c6e707854120b0a06b8932001fc7d988a4' => 
    array (
      0 => '/var/www/html/shopware_test/themes/Backend/ExtJs/backend/index/view/widgets/sales.js',
      1 => 1598958813,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '21429534085f579091d73cf6-17580670',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_5f579091d814b6_40064680',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5f579091d814b6_40064680')) {function content_5f579091d814b6_40064680($_smarty_tpl) {?>/**
 * Shopware 5
...
Ext.define('Shopware.apps.Index.view.widgets.Sales', {
    ...
    title: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'sales'/'title','default'=>'Turnover today / yesterday (Sample Data)','namespace'=>'backend/index/view/widgets')); $_block_repeat=true; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'sales'/'title','default'=>'Turnover today / yesterday (Sample Data)','namespace'=>'backend/index/view/widgets'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Umsatz - heute und gestern<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'sales'/'title','default'=>'Turnover today / yesterday (Sample Data)','namespace'=>'backend/index/view/widgets'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
    layout: {
        type: 'vbox',
        align: 'stretch',
     ...
     */
    snippets: {
        conversation_rate: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'sales'/'conversation_rate','default'=>'Conversation rate','namespace'=>'backend/index/view/widgets')); $_block_repeat=true; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'sales'/'conversation_rate','default'=>'Conversation rate','namespace'=>'backend/index/view/widgets'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Conversionrate (der letzten 7 Tage)<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'sales'/'conversation_rate','default'=>'Conversation rate','namespace'=>'backend/index/view/widgets'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
        headers: {
            turnover: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'sales'/'headers'/'turnover','default'=>'Turnover','namespace'=>'backend/index/view/widgets')); $_block_repeat=true; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'sales'/'headers'/'turnover','default'=>'Turnover','namespace'=>'backend/index/view/widgets'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Umsatz<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'sales'/'headers'/'turnover','default'=>'Turnover','namespace'=>'backend/index/view/widgets'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
            orders: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'sales/headers/orders','default'=>'Orders','namespace'=>'backend/index/view/widgets')); $_block_repeat=true; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'sales/headers/orders','default'=>'Orders','namespace'=>'backend/index/view/widgets'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Bestellungen<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'sales/headers/orders','default'=>'Orders','namespace'=>'backend/index/view/widgets'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
            new_customers: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'sales/headers/new_customers','default'=>'New Customers','namespace'=>'backend/index/view/widgets')); $_block_repeat=true; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'sales/headers/new_customers','default'=>'New Customers','namespace'=>'backend/index/view/widgets'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Neukunden<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'sales/headers/new_customers','default'=>'New Customers','namespace'=>'backend/index/view/widgets'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
            visitors: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'sales/headers/visitors','default'=>'Visitors','namespace'=>'backend/index/view/widgets')); $_block_repeat=true; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'sales/headers/visitors','default'=>'Visitors','namespace'=>'backend/index/view/widgets'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Besucher<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'sales/headers/visitors','default'=>'Visitors','namespace'=>'backend/index/view/widgets'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
'
        }
    },
