<?php /* Smarty version Smarty-3.1.12, created on 2020-09-09 09:25:14
         compiled from "/var/www/html/shopware_test/themes/Backend/ExtJs/backend/article_list/controller/filter.js" */ ?>
<?php /*%%SmartyHeaderCode:18644395755f58835a513394-09511675%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '041d8b3d9dcfc1afce43425e079d650ac6102f7f' => 
    array (
      0 => '/var/www/html/shopware_test/themes/Backend/ExtJs/backend/article_list/controller/filter.js',
      1 => 1598958813,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '18644395755f58835a513394-09511675',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_5f58835a52f738_56882942',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5f58835a52f738_56882942')) {function content_5f58835a52f738_56882942($_smarty_tpl) {?>/**
 * Shopware 5
        ...
        if (newTab.internalTitle === 'simple') {
            ...
            if (value || oldValue.trim().length === 0) {
                ...
                Ext.MessageBox.confirm(
                    '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'proceed','default'=>'Proceed?','namespace'=>'backend/article_list/main')); $_block_repeat=true; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'proceed','default'=>'Proceed?','namespace'=>'backend/article_list/main'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Fortfahren?<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'proceed','default'=>'Proceed?','namespace'=>'backend/article_list/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
                    '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'convertFilterMessage','default'=>'You cannot convert this query to a simple filter. Do you want to proceed anyway and loose the current filter?','namespace'=>'backend/article_list/main')); $_block_repeat=true; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'convertFilterMessage','default'=>'You cannot convert this query to a simple filter. Do you want to proceed anyway and loose the current filter?','namespace'=>'backend/article_list/main'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
    ...
    onSaveFilter: function(button, event) {
        ...
        if (!suggestController.isFilterValid(filterString)) {
            ...
            if (!filterString) {
                ...
                message = Ext.String.format('<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'parserError','default'=>'Could not parse the string \\\'[0]\\\': <br><br>[1]','namespace'=>'backend/article_list/main')); $_block_repeat=true; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'parserError','default'=>'Could not parse the string \\\'[0]\\\': <br><br>[1]','namespace'=>'backend/article_list/main'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Kann die Zeichenkette nicht verarbeiten \'[0]\': <br><br>[1]<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'parserError','default'=>'Could not parse the string \\\'[0]\\\': <br><br>[1]','namespace'=>'backend/article_list/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
