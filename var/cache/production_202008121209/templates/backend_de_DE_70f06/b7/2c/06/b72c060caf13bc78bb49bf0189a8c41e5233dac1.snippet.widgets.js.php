<?php /* Smarty version Smarty-3.1.12, created on 2020-09-08 16:09:21
         compiled from "/var/www/html/shopware_test/themes/Backend/ExtJs/backend/index/controller/widgets.js" */ ?>
<?php /*%%SmartyHeaderCode:2511877715f579091eb2042-75849418%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b72c060caf13bc78bb49bf0189a8c41e5233dac1' => 
    array (
      0 => '/var/www/html/shopware_test/themes/Backend/ExtJs/backend/index/controller/widgets.js',
      1 => 1598958813,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2511877715f579091eb2042-75849418',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_5f579091ed6501_28397028',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5f579091ed6501_28397028')) {function content_5f579091ed6501_28397028($_smarty_tpl) {?>/**
 * Shopware 5
...
Ext.define('Shopware.apps.Index.controller.Widgets', {
    ...
    snippets: {
        error: {
            viewportNotLoaded: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'error/viewportNotLoaded','default'=>'Viewport is not loaded.','namespace'=>'backend/index/controller/widgets')); $_block_repeat=true; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'error/viewportNotLoaded','default'=>'Viewport is not loaded.','namespace'=>'backend/index/controller/widgets'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Viewport wurde nicht geladen.<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'error/viewportNotLoaded','default'=>'Viewport is not loaded.','namespace'=>'backend/index/controller/widgets'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
            settingsInitialisation: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'error/settingsInitialisation','default'=>'Widget settings could not be initialized.','namespace'=>'backend/index/controller/widgets')); $_block_repeat=true; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'error/settingsInitialisation','default'=>'Widget settings could not be initialized.','namespace'=>'backend/index/controller/widgets'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Widget Einstellungen konnten nicht initialisiert werden.<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'error/settingsInitialisation','default'=>'Widget settings could not be initialized.','namespace'=>'backend/index/controller/widgets'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
            deleteWidget: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'error/deleteWidget','default'=>'An Error occurred while attempting to delete the widget.\\n\\n','namespace'=>'backend/index/controller/widgets')); $_block_repeat=true; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'error/deleteWidget','default'=>'An Error occurred while attempting to delete the widget.\\n\\n','namespace'=>'backend/index/controller/widgets'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Ein Fehler ist bei dem löschen des Widgets aufgetreten.<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'error/deleteWidget','default'=>'An Error occurred while attempting to delete the widget.\\n\\n','namespace'=>'backend/index/controller/widgets'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
            merchantWidgetError: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'error/merchantWidgetError','default'=>'An error occurred in the merchants widget','namespace'=>'backend/index/controller/widgets')); $_block_repeat=true; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'error/merchantWidgetError','default'=>'An error occurred in the merchants widget','namespace'=>'backend/index/controller/widgets'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
...
'
        ...
        titles: {
            allow_merchant: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'titles'/'allow_merchant','default'=>'Unlock merchant','namespace'=>'backend/index/controller/widgets')); $_block_repeat=true; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'titles'/'allow_merchant','default'=>'Unlock merchant','namespace'=>'backend/index/controller/widgets'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Freischalten & Bestätigung verschicken<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'titles'/'allow_merchant','default'=>'Unlock merchant','namespace'=>'backend/index/controller/widgets'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
            decline_merchant: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'titles'/'decline_merchant','default'=>'Decline merchant','namespace'=>'backend/index/controller/widgets')); $_block_repeat=true; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'titles'/'decline_merchant','default'=>'Decline merchant','namespace'=>'backend/index/controller/widgets'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Anfrage ablehnen<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'titles'/'decline_merchant','default'=>'Decline merchant','namespace'=>'backend/index/controller/widgets'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
'
        }
    },
    ...
    askForNotificationPermission: function () {
        ...
        if (Notification.permission === 'default') {
            Ext.MessageBox.confirm(
                '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'footer/notification/modal_title','namespace'=>'backend/index/controller/widgets','default'=>'Show notifications on desktop?')); $_block_repeat=true; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'footer/notification/modal_title','namespace'=>'backend/index/controller/widgets','default'=>'Show notifications on desktop?'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Desktop Benachrichtungen aktivieren?<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'footer/notification/modal_title','namespace'=>'backend/index/controller/widgets','default'=>'Show notifications on desktop?'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
                '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'footer/notification/modal_content','namespace'=>'backend/index/controller/widgets','default'=>'To show growl notifications, ')); $_block_repeat=true; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'footer/notification/modal_content','namespace'=>'backend/index/controller/widgets','default'=>'To show growl notifications, '), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Damit Du keine Benachrichtigung verpasst wenn Du ggw. einen anderen Tab Deines Browser oder ein anderes Programm nutzt kann Shopware Dir eingehende Benachrichtigungen an den Desktop weiterleiten. Hierfür ist eine entsprechende Berechtigung nötig.<br><br>Jetzt nach der Berechtigung für Benachrichtigungen fragen?<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'footer/notification/modal_content','namespace'=>'backend/index/controller/widgets','default'=>'To show growl notifications, '), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
', function (response) {
                if (response !== 'yes') {
                    return false;
                }
                ...
                Notification.requestPermission().then( function (result) {
                    if (result === 'denied' ){
                        Ext.MessageBox.alert('<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'footer/notification/denied_title','namespace'=>'backend/index/controller/widgets','default'=>'Denied')); $_block_repeat=true; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'footer/notification/denied_title','namespace'=>'backend/index/controller/widgets','default'=>'Denied'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Berechtigung verweigert<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'footer/notification/denied_title','namespace'=>'backend/index/controller/widgets','default'=>'Denied'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
                            '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'footer/notification/denied_content','namespace'=>'backend/index/controller/widgets','default'=>'If you change your mind later, please go to your browser settings for this site.')); $_block_repeat=true; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'footer/notification/denied_content','namespace'=>'backend/index/controller/widgets','default'=>'If you change your mind later, please go to your browser settings for this site.'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Die Berechtigung für Benachrichtigungen wurde verweigert. Solltest Du Deine Meinung später ändern kannst Du diese Berechtigung in den Einstellungen Deines Browsers für diese Seite ändern.<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'footer/notification/denied_content','namespace'=>'backend/index/controller/widgets','default'=>'If you change your mind later, please go to your browser settings for this site.'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
');
                    }
        ...
        var tooltipText = '<span><?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'footer/notification/granted_denied_tooltip','namespace'=>'backend/index/controller/widgets','default'=>'Permission was already granted or denied')); $_block_repeat=true; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'footer/notification/granted_denied_tooltip','namespace'=>'backend/index/controller/widgets','default'=>'Permission was already granted or denied'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Die Berechtigung wurde bereits erteilt oder blockiert. Eine Änderung ist nur über die Browsereinstellungen möglich<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'footer/notification/granted_denied_tooltip','namespace'=>'backend/index/controller/widgets','default'=>'Permission was already granted or denied'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
</span><div class="x-clear"></div><div class="arrow"></div>';
        if (document.location.protocol !== 'https:') {
            tooltipText = '<span><?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'footer/notification/missing_https_content_tooltip','namespace'=>'backend/index/controller/widgets','default'=>'To be able to use desktop notifications, please make sure you\\\'re using an SSL encrypted connection.')); $_block_repeat=true; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'footer/notification/missing_https_content_tooltip','namespace'=>'backend/index/controller/widgets','default'=>'To be able to use desktop notifications, please make sure you\\\'re using an SSL encrypted connection.'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Um Desktop-Benachrichtigungen nutzen zu können ist eine SSL verschlüsselte Verbindung notwendig.<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'footer/notification/missing_https_content_tooltip','namespace'=>'backend/index/controller/widgets','default'=>'To be able to use desktop notifications, please make sure you\\\'re using an SSL encrypted connection.'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
</span><div class="x-clear"></div><div class="arrow"></div>'
        }
