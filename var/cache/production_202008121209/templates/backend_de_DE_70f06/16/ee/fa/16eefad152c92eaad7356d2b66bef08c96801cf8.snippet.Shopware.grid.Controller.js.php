<?php /* Smarty version Smarty-3.1.12, created on 2020-09-09 09:25:11
         compiled from "/var/www/html/shopware_test/themes/Backend/ExtJs/backend/base/application/Shopware.grid.Controller.js" */ ?>
<?php /*%%SmartyHeaderCode:4074900715f588357e6e615-33834210%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '16eefad152c92eaad7356d2b66bef08c96801cf8' => 
    array (
      0 => '/var/www/html/shopware_test/themes/Backend/ExtJs/backend/base/application/Shopware.grid.Controller.js',
      1 => 1598958813,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '4074900715f588357e6e615-33834210',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_5f588357eab049_62057911',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5f588357eab049_62057911')) {function content_5f588357eab049_62057911($_smarty_tpl) {?>
/**
...
Ext.define('Shopware.grid.Controller', {
     ...
     * @type { string }
     */
    deleteConfirmTitle: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'grid_controller/delete_confirm_title','default'=>'Delete items','namespace'=>'backend/application/main')); $_block_repeat=true; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'grid_controller/delete_confirm_title','default'=>'Delete items','namespace'=>'backend/application/main'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Einträge löschen<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'grid_controller/delete_confirm_title','default'=>'Delete items','namespace'=>'backend/application/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
     ...
     * @type { string }
     */
    deleteConfirmText: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'grid_controller/delete_confirm_text','default'=>'Are you sure you want to delete the selected items?','namespace'=>'backend/application/main')); $_block_repeat=true; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'grid_controller/delete_confirm_text','default'=>'Are you sure you want to delete the selected items?','namespace'=>'backend/application/main'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Bist Du sicher, dass Du die markierten Einträge löschen möchtest?<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'grid_controller/delete_confirm_text','default'=>'Are you sure you want to delete the selected items?','namespace'=>'backend/application/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
     ...
     * @type { string }
     */
    deleteInfoText: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'grid_controller/delete_info_text','default'=>'<b>The records will be deleted.</b> <br>To cancel the process, you can use the <b><i>`Cancel process`</i></b> Button. Depending on the selected volume of data may take several seconds to complete this process.','namespace'=>'backend/application/main')); $_block_repeat=true; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'grid_controller/delete_info_text','default'=>'<b>The records will be deleted.</b> <br>To cancel the process, you can use the <b><i>`Cancel process`</i></b> Button. Depending on the selected volume of data may take several seconds to complete this process.','namespace'=>'backend/application/main'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
...
',
     ...
     * @type { string }
     */
    deleteProgressBarText: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'grid_controller/delete_progress_bar_text','default'=>'Item [0] of [1]','namespace'=>'backend/application/main')); $_block_repeat=true; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'grid_controller/delete_progress_bar_text','default'=>'Item [0] of [1]','namespace'=>'backend/application/main'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Eintrag [0] von [1]<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'grid_controller/delete_progress_bar_text','default'=>'Item [0] of [1]','namespace'=>'backend/application/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
