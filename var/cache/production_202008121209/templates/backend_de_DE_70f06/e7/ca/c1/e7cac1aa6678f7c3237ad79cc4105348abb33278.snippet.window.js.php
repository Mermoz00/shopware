<?php /* Smarty version Smarty-3.1.12, created on 2020-09-09 09:25:12
         compiled from "/var/www/html/shopware_test/themes/Backend/ExtJs/backend/index/view/widgets/window.js" */ ?>
<?php /*%%SmartyHeaderCode:16145985565f588358c20784-05242111%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e7cac1aa6678f7c3237ad79cc4105348abb33278' => 
    array (
      0 => '/var/www/html/shopware_test/themes/Backend/ExtJs/backend/index/view/widgets/window.js',
      1 => 1598958813,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '16145985565f588358c20784-05242111',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_5f588358c3c582_11304665',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5f588358c3c582_11304665')) {function content_5f588358c3c582_11304665($_smarty_tpl) {?>/**
 * Shopware 5
...
Ext.define('Shopware.apps.Index.view.widgets.Window', {
    ...
    snippets: {
        toolbar: {
            title: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'window/toolbar/headline','default'=>'Widgets','namespace'=>'backend/index/view/widgets')); $_block_repeat=true; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'window/toolbar/headline','default'=>'Widgets','namespace'=>'backend/index/view/widgets'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Widgets<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'window/toolbar/headline','default'=>'Widgets','namespace'=>'backend/index/view/widgets'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
            minimize: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'window/toolbar/minimize','default'=>'Minimize window','namespace'=>'backend/index/view/widgets')); $_block_repeat=true; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'window/toolbar/minimize','default'=>'Minimize window','namespace'=>'backend/index/view/widgets'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Fenster minimieren<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'window/toolbar/minimize','default'=>'Minimize window','namespace'=>'backend/index/view/widgets'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
            dock: {
                topLeft: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'window/toolbar/dock/topLeft','default'=>'Top left','namespace'=>'backend/index/view/widgets')); $_block_repeat=true; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'window/toolbar/dock/topLeft','default'=>'Top left','namespace'=>'backend/index/view/widgets'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Oben links<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'window/toolbar/dock/topLeft','default'=>'Top left','namespace'=>'backend/index/view/widgets'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
                topRight: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'window/toolbar/dock/topRight','default'=>'Top right','namespace'=>'backend/index/view/widgets')); $_block_repeat=true; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'window/toolbar/dock/topRight','default'=>'Top right','namespace'=>'backend/index/view/widgets'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Oben rechts<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'window/toolbar/dock/topRight','default'=>'Top right','namespace'=>'backend/index/view/widgets'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
                bottomLeft: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'window/toolbar/dock/bottomLeft','default'=>'Bottom left','namespace'=>'backend/index/view/widgets')); $_block_repeat=true; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'window/toolbar/dock/bottomLeft','default'=>'Bottom left','namespace'=>'backend/index/view/widgets'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Unten links<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'window/toolbar/dock/bottomLeft','default'=>'Bottom left','namespace'=>'backend/index/view/widgets'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
                bottomRight: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'window/toolbar/dock/bottomRight','default'=>'Bottom right','namespace'=>'backend/index/view/widgets')); $_block_repeat=true; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'window/toolbar/dock/bottomRight','default'=>'Bottom right','namespace'=>'backend/index/view/widgets'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Unten rechts<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'window/toolbar/dock/bottomRight','default'=>'Bottom right','namespace'=>'backend/index/view/widgets'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
'
            }
        }
    },
    ...
    createWidgetMenuItems: function () {
        ...
        items.push({
            text: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'shopware_bi','namespace'=>'backend/index/view/widgets')); $_block_repeat=true; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'shopware_bi','namespace'=>'backend/index/view/widgets'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Shopware BI<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'shopware_bi','namespace'=>'backend/index/view/widgets'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
            widgetId: null,
            iconCls: 'sprite-plus-circle-frame',
            listeners: {
