<?php /* Smarty version Smarty-3.1.12, created on 2020-09-08 16:09:20
         compiled from "/var/www/html/shopware_test/themes/Backend/ExtJs/backend/base/application/Shopware.detail.Controller.js" */ ?>
<?php /*%%SmartyHeaderCode:13175717295f579090e1a442-13690709%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'bb8b2da665c2926cfc07aa10ad23c33cf6a8d34e' => 
    array (
      0 => '/var/www/html/shopware_test/themes/Backend/ExtJs/backend/base/application/Shopware.detail.Controller.js',
      1 => 1598958813,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '13175717295f579090e1a442-13690709',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_5f579090e2c773_40982079',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5f579090e2c773_40982079')) {function content_5f579090e2c773_40982079($_smarty_tpl) {?>
//
//
Ext.define('Shopware.detail.Controller', {
     ...
     * @type { String }
     */
    saveSuccessTitle: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'detail_controller/save_success_title','default'=>'Success','namespace'=>'backend/application/main')); $_block_repeat=true; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'detail_controller/save_success_title','default'=>'Success','namespace'=>'backend/application/main'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Erfolgreich<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'detail_controller/save_success_title','default'=>'Success','namespace'=>'backend/application/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
     ...
     * @type { String }
     */
    saveSuccessMessage: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'detail_controller/save_success_message','default'=>'Item saved successfully','namespace'=>'backend/application/main')); $_block_repeat=true; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'detail_controller/save_success_message','default'=>'Item saved successfully','namespace'=>'backend/application/main'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Eintrag wurde erfolgreich gespeichert<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'detail_controller/save_success_message','default'=>'Item saved successfully','namespace'=>'backend/application/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
     ...
     * @type { String }
     */
    violationErrorTitle: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'detail_controller/violation_error_title','default'=>'Violation errors','namespace'=>'backend/application/main')); $_block_repeat=true; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'detail_controller/violation_error_title','default'=>'Violation errors','namespace'=>'backend/application/main'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Validierungsfehler<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'detail_controller/violation_error_title','default'=>'Violation errors','namespace'=>'backend/application/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
     ...
     * @type { String }
     */
    invalidFormTitle: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'detail_controller/invalid_form_title','default'=>'Form validation error','namespace'=>'backend/application/main')); $_block_repeat=true; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'detail_controller/invalid_form_title','default'=>'Form validation error','namespace'=>'backend/application/main'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Fehler bei der Formularvalidierung<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'detail_controller/invalid_form_title','default'=>'Form validation error','namespace'=>'backend/application/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
     ...
     * @type { String }
     */
    invalidFormMessage: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'detail_controller/invalid_form_message','default'=>'The form contains invalid data, please check the inserted values.','namespace'=>'backend/application/main')); $_block_repeat=true; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'detail_controller/invalid_form_message','default'=>'The form contains invalid data, please check the inserted values.','namespace'=>'backend/application/main'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Das Formular beinhaltet ungültige Daten, bitte prüfe Deine Eingabe.<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'detail_controller/invalid_form_message','default'=>'The form contains invalid data, please check the inserted values.','namespace'=>'backend/application/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
