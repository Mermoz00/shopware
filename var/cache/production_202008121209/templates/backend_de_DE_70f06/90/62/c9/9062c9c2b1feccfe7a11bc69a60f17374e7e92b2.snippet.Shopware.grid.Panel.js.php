<?php /* Smarty version Smarty-3.1.12, created on 2020-09-08 16:09:20
         compiled from "/var/www/html/shopware_test/themes/Backend/ExtJs/backend/base/application/Shopware.grid.Panel.js" */ ?>
<?php /*%%SmartyHeaderCode:1066458435f579090d3e934-04583219%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '9062c9c2b1feccfe7a11bc69a60f17374e7e92b2' => 
    array (
      0 => '/var/www/html/shopware_test/themes/Backend/ExtJs/backend/base/application/Shopware.grid.Panel.js',
      1 => 1598958813,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1066458435f579090d3e934-04583219',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_5f579090d6c698_99580884',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5f579090d6c698_99580884')) {function content_5f579090d6c698_99580884($_smarty_tpl) {?>/**
...
Ext.define('Shopware.grid.Panel', {
     ...
     * @type { String }
     */
    pageSizeLabel: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'grid_panel/page_size_label','default'=>'Items per page','namespace'=>'backend/application/main')); $_block_repeat=true; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'grid_panel/page_size_label','default'=>'Items per page','namespace'=>'backend/application/main'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Einträge pro Seite<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'grid_panel/page_size_label','default'=>'Items per page','namespace'=>'backend/application/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
...
',
     ...
     * @type { String }
     */
    deleteButtonText: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'grid_panel/delete_button_text','default'=>'Delete all selected','namespace'=>'backend/application/main')); $_block_repeat=true; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'grid_panel/delete_button_text','default'=>'Delete all selected','namespace'=>'backend/application/main'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Markierte Einträge löschen<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'grid_panel/delete_button_text','default'=>'Delete all selected','namespace'=>'backend/application/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
     ...
     * @type { String }
     */
    searchFieldText: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'grid_panel/search_field_text','default'=>'Search ...','namespace'=>'backend/application/main')); $_block_repeat=true; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'grid_panel/search_field_text','default'=>'Search ...','namespace'=>'backend/application/main'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Suche ...<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'grid_panel/search_field_text','default'=>'Search ...','namespace'=>'backend/application/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
     ...
     * @type { String }
     */
    pagingItemText: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'grid_panel/paging_toolbar/item_text','default'=>'items','namespace'=>'backend/application/main')); $_block_repeat=true; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'grid_panel/paging_toolbar/item_text','default'=>'items','namespace'=>'backend/application/main'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Einträge<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'grid_panel/paging_toolbar/item_text','default'=>'items','namespace'=>'backend/application/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
