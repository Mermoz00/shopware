<?php /* Smarty version Smarty-3.1.12, created on 2020-09-09 09:25:14
         compiled from "/var/www/html/shopware_test/themes/Backend/ExtJs/backend/article/controller/media.js" */ ?>
<?php /*%%SmartyHeaderCode:16512293915f58835ac392d9-56431531%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd816e38b2cac61d643467c8c0e129e0ecd66f29e' => 
    array (
      0 => '/var/www/html/shopware_test/themes/Backend/ExtJs/backend/article/controller/media.js',
      1 => 1598958813,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '16512293915f58835ac392d9-56431531',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_5f58835ac5a454_01475916',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5f58835ac5a454_01475916')) {function content_5f58835ac5a454_01475916($_smarty_tpl) {?>/**
 * Shopware 5
...
Ext.define('Shopware.apps.Article.controller.Media', {
    ...
    snippets: {
        upload: {
            text: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'media'/'upload'/'text','default'=>'The image was uploaded successfully.','namespace'=>'backend/article/view/main')); $_block_repeat=true; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'media'/'upload'/'text','default'=>'The image was uploaded successfully.','namespace'=>'backend/article/view/main'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Das Bild wurde erfolgreich hochgeladen. Bitte verknüpfe jetzt das Bild mit dem Artikel.<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'media'/'upload'/'text','default'=>'The image was uploaded successfully.','namespace'=>'backend/article/view/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
'
        },
        success: {
            title: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'media'/'success'/'title','default'=>'Success','namespace'=>'backend/article/view/main')); $_block_repeat=true; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'media'/'success'/'title','default'=>'Success','namespace'=>'backend/article/view/main'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Erfolg<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'media'/'success'/'title','default'=>'Success','namespace'=>'backend/article/view/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
            mapping: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'media'/'success'/'mapping','default'=>'The image mapping saved successfully','namespace'=>'backend/article/view/main')); $_block_repeat=true; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'media'/'success'/'mapping','default'=>'The image mapping saved successfully','namespace'=>'backend/article/view/main'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Die Bild-Zuordnung wurde erfolgreich gespeichert<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'media'/'success'/'mapping','default'=>'The image mapping saved successfully','namespace'=>'backend/article/view/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
'
        },
        failure: {
            title: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'media'/'failure'/'title','default'=>'Failure','namespace'=>'backend/article/view/main')); $_block_repeat=true; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'media'/'failure'/'title','default'=>'Failure','namespace'=>'backend/article/view/main'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
...
',
            mapping: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'media'/'failure'/'mapping_violation','default'=>'An error occurred while saving the image mapping:','namespace'=>'backend/article/view/main')); $_block_repeat=true; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'media'/'failure'/'mapping_violation','default'=>'An error occurred while saving the image mapping:','namespace'=>'backend/article/view/main'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Ein Fehler ist beim Speichern der Zuordnung aufgetreten:<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'media'/'failure'/'mapping_violation','default'=>'An error occurred while saving the image mapping:','namespace'=>'backend/article/view/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
            noIdViolation: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'media'/'failure'/'no_id_violation','default'=>'No id passed to the php controller action','namespace'=>'backend/article/view/main')); $_block_repeat=true; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'media'/'failure'/'no_id_violation','default'=>'No id passed to the php controller action','namespace'=>'backend/article/view/main'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Es wurde keine ID zum PHP-Controller übergeben<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'media'/'failure'/'no_id_violation','default'=>'No id passed to the php controller action','namespace'=>'backend/article/view/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
            noMoreInformation: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'media'/'failure'/'no_more_information','default'=>'No more information available.','namespace'=>'backend/article/view/main')); $_block_repeat=true; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'media'/'failure'/'no_more_information','default'=>'No more information available.','namespace'=>'backend/article/view/main'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
...
',
            onlyOneCanBeChecked: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'media'/'failure'/'only_one_node','default'=>'You can only activate one configurator option per configurator group.','namespace'=>'backend/article/view/main')); $_block_repeat=true; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'media'/'failure'/'only_one_node','default'=>'You can only activate one configurator option per configurator group.','namespace'=>'backend/article/view/main'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Du kannst nur eine Konfigurator-Option pro Konfigurator-Gruppe aktivieren.<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'media'/'failure'/'only_one_node','default'=>'You can only activate one configurator option per configurator group.','namespace'=>'backend/article/view/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
'
        },
        growlMessage: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'growlMessage','default'=>'Article','namespace'=>'backend/article/view/main')); $_block_repeat=true; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'growlMessage','default'=>'Article','namespace'=>'backend/article/view/main'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Artikel<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'growlMessage','default'=>'Article','namespace'=>'backend/article/view/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
'
    },
            ...
            configure: function() {
                return {
                    tasks: [{
                        ...
                        data: records,
                        text: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'image/variant_info/progress/progress_text','default'=>'Image [0] of [1]','namespace'=>'backend/article/view/main')); $_block_repeat=true; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'image/variant_info/progress/progress_text','default'=>'Image [0] of [1]','namespace'=>'backend/article/view/main'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Bild [0] von [1]<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'image/variant_info/progress/progress_text','default'=>'Image [0] of [1]','namespace'=>'backend/article/view/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
                        totalCount: records.length
                    }],

                    infoText: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'image/variant_info/progress/description','default'=>'<h2>Assign image variants</h2>You can use the <b><i>`Cancel process`</i></b> button the cancel the process. Depending on the amount of the data set, this process might take a while.','namespace'=>'backend/article/view/main')); $_block_repeat=true; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'image/variant_info/progress/description','default'=>'<h2>Assign image variants</h2>You can use the <b><i>`Cancel process`</i></b> button the cancel the process. Depending on the amount of the data set, this process might take a while.','namespace'=>'backend/article/view/main'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
<p><b>Achtung! Alle zuvor eingestellten Konfigurationen der ausgewählten Bilder werden verworfen!</b></p>Du kannst den <b>\'Abbrechen\'</b> Button verwenden, um den Prozess abzubrechen. Je nach Anzahl der zu verarbeitenden Daten, kann der Prozess eine Weile dauern.<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'image/variant_info/progress/description','default'=>'<h2>Assign image variants</h2>You can use the <b><i>`Cancel process`</i></b> button the cancel the process. Depending on the amount of the data set, this process might take a while.','namespace'=>'backend/article/view/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
'
                }
            }
        }).show();
