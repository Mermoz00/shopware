<?php /* Smarty version Smarty-3.1.12, created on 2020-09-08 16:09:20
         compiled from "/var/www/html/shopware_test/themes/Backend/ExtJs/backend/base/application/Shopware.listing.FilterPanel.js" */ ?>
<?php /*%%SmartyHeaderCode:20871978425f579090e42c34-15653587%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '1c6e01a25f0667f90b2c4fca0ff34bd4b854a086' => 
    array (
      0 => '/var/www/html/shopware_test/themes/Backend/ExtJs/backend/base/application/Shopware.listing.FilterPanel.js',
      1 => 1598958813,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '20871978425f579090e42c34-15653587',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_5f579090e63a25_25815559',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5f579090e63a25_25815559')) {function content_5f579090e63a25_25815559($_smarty_tpl) {?>
//
//
...
Ext.define('Shopware.listing.FilterPanel', {
     ...
     * #@type { String }
     */
    title: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'filter_panel/title','default'=>'Filters','namespace'=>'backend/application/main')); $_block_repeat=true; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'filter_panel/title','default'=>'Filters','namespace'=>'backend/application/main'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Filter<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'filter_panel/title','default'=>'Filters','namespace'=>'backend/application/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
     ...
     * @type { String }
     */
    infoTextSnippet: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'filter_panel/info_text','default'=>'Activate the filter by clicking the regarding checkbox. These filters will be linked with an AND condition.','namespace'=>'backend/application/main')); $_block_repeat=true; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'filter_panel/info_text','default'=>'Activate the filter by clicking the regarding checkbox. These filters will be linked with an AND condition.','namespace'=>'backend/application/main'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Aktiviere die gewünschten Filter über die jeweilige Checkbox. Aktivierte Filter werden mit einer UND-Bedingung verknüpft.<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'filter_panel/info_text','default'=>'Activate the filter by clicking the regarding checkbox. These filters will be linked with an AND condition.','namespace'=>'backend/application/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
...
',
     ...
     * @type { String }
     */
    resetButtonText: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'filter_panel/reset_button_text','default'=>'Reset filters','namespace'=>'backend/application/main')); $_block_repeat=true; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'filter_panel/reset_button_text','default'=>'Reset filters','namespace'=>'backend/application/main'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Filter zurücksetzen<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'filter_panel/reset_button_text','default'=>'Reset filters','namespace'=>'backend/application/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
