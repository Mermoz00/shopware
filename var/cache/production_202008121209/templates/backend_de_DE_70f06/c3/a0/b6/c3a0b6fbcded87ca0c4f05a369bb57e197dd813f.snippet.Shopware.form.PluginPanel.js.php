<?php /* Smarty version Smarty-3.1.12, created on 2020-09-09 09:25:12
         compiled from "/var/www/html/shopware_test/themes/Backend/ExtJs/backend/base/component/Shopware.form.PluginPanel.js" */ ?>
<?php /*%%SmartyHeaderCode:5994065795f5883582cc798-92147553%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c3a0b6fbcded87ca0c4f05a369bb57e197dd813f' => 
    array (
      0 => '/var/www/html/shopware_test/themes/Backend/ExtJs/backend/base/component/Shopware.form.PluginPanel.js',
      1 => 1598958813,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '5994065795f5883582cc798-92147553',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_5f5883582e1d68_23712079',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5f5883582e1d68_23712079')) {function content_5f5883582e1d68_23712079($_smarty_tpl) {?>/**
 * Shopware 5
...
/** @lends Ext.form.Panel# */
{
    ...
    snippets: {
        resetButton: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'form'/'reset_text','default'=>'Reset','namespace'=>'backend/config/controller/main')); $_block_repeat=true; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'form'/'reset_text','default'=>'Reset','namespace'=>'backend/config/controller/main'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Zurücksetzen<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'form'/'reset_text','default'=>'Reset','namespace'=>'backend/config/controller/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
        saveButton: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'form'/'save_text','default'=>'Save','namespace'=>'backend/config/controller/main')); $_block_repeat=true; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'form'/'save_text','default'=>'Save','namespace'=>'backend/config/controller/main'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Speichern<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'form'/'save_text','default'=>'Save','namespace'=>'backend/config/controller/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
        description: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'form'/'description_title','default'=>'Description','namespace'=>'backend/config/controller/main')); $_block_repeat=true; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'form'/'description_title','default'=>'Description','namespace'=>'backend/config/controller/main'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Beschreibung<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'form'/'description_title','default'=>'Description','namespace'=>'backend/config/controller/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
        onSaveFormTitle: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'form'/'message'/'save_form_title','default'=>'Save form','namespace'=>'backend/config/controller/main')); $_block_repeat=true; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'form'/'message'/'save_form_title','default'=>'Save form','namespace'=>'backend/config/controller/main'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Formular speichern<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'form'/'message'/'save_form_title','default'=>'Save form','namespace'=>'backend/config/controller/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
        saveFormSuccess: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'form'/'message'/'save_form_success','default'=>'Form „[name]“ has been saved.','namespace'=>'backend/config/controller/main')); $_block_repeat=true; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'form'/'message'/'save_form_success','default'=>'Form „[name]“ has been saved.','namespace'=>'backend/config/controller/main'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Formular "[name]" wurde gespeichert.<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'form'/'message'/'save_form_success','default'=>'Form „[name]“ has been saved.','namespace'=>'backend/config/controller/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
        saveFormError: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'form'/'message'/'save_form_error','default'=>'Form „[name]“ could not be saved.','namespace'=>'backend/config/controller/main')); $_block_repeat=true; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'form'/'message'/'save_form_error','default'=>'Form „[name]“ could not be saved.','namespace'=>'backend/config/controller/main'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Forumular "[name]" konnte nicht gespeichert werden.<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'form'/'message'/'save_form_error','default'=>'Form „[name]“ could not be saved.','namespace'=>'backend/config/controller/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
'
    },
